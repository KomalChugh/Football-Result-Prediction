...
if __name__ =="__main__":
	...
	num1 = int(sys.argv[1]) # number of neurons in hidden layer 1
	num2 = int(sys.argv[2]) # number of neurons in hidden layer 2
	X_train , y_train , X_test , y_test = preprocess() # get the datasets
	...
	Run_Neural_Network( 200 , 0.01 , 128 , X_train , y_train , X_test , y_test , len(X_train[0]) , num1 , num2) 
